...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    //Shooter Controls
    driver.rightTrigger().toggleOnTrue(new ShootAtVeolcity(mShooterPrototype, mUptakeSubsystem, mSpindexerSubsystem, shooterConstants.shooterSpeed));
    ...
    */
    ...
    //System Speed Optimization Testing
